...
import com.moonring.ring.databinding.FragmentSleepDetailBinding
import com.moonring.ring.enums.DateType
import com.moonring.ring.viewmodule.state.SharedChartDataModel
import com.moonring.ring.viewmodule.state.SleepDetailViewModel
 ...
 *    desc   :
 */
class SleepDetailFragment : BaseBarFragment<SleepDetailViewModel, FragmentSleepDetailBinding>() {
    ...
    private val dayFragment by lazy {
        SleepChartFragment.newInstance(DateType.Day.name)
    }

    private val weekFragment by lazy {
        SleepChartFragment.newInstance(DateType.Week.name)
    }

    private val monthFragment by lazy {
        SleepChartFragment.newInstance(DateType.Month.name)
    }
