package com.module.common.support.glide;
...
public class GlideUtils {
    /*** 占位图 */
    public static int placeholderImage = R.drawable.image_round_defalut;
    /*** 错误图 */
    public static int errorImage = R.drawable.image_round_defalut;
...
//        Glide.with(context).load(url).apply(options).into(imageView);
    ...
    public static void loadCircleWithBorderImage(Context context, String url, ImageView imageView,
        ...
        RequestOptions options = RequestOptions.bitmapTransform(
                        new MultiTransformation<>(
                                new CenterCrop(),
                                new CropCircleWithBorderTransformation(ConvertUtils.px2dp(borderSize), borderColor)
                        ))
                .placeholder(placeholderImage) //占位图
                .error(errorImage);            //错误图
        Glide.with(context).load(url).apply(options).into(imageView);
    ...
    public static void loadRoundCircleImage(Context context, String url, ImageView imageView,
        ...
        RequestOptions options = RequestOptions.bitmapTransform(
                        new MultiTransformation<>(
                                new CenterCrop(),
                                new RoundedCornersTransformation(ConvertUtils.px2dp(radius), 0,
     ...
     * @param radius    圆角 px
     */
    public static void loadRoundCircleImageLoacl(Context context, int url, ImageView imageView,
                                            float radius) {
        RequestOptions options = RequestOptions.bitmapTransform(
                        new MultiTransformation<>(
                                new CenterCrop(),
    ...
    public static void loadRoundCircleImage(Context context, String url, ImageView imageView,
        ...
        RequestOptions options = RequestOptions.bitmapTransform(
                        new MultiTransformation<>(
                                new CenterCrop(),
                                new RoundedCornersTransformation(ConvertUtils.px2dp( radius), 0, type)
                        ))
                .placeholder(placeholderImage) //占位图
                .error(errorImage);            //错误图
        Glide.with(context).load(url).apply(options).into(imageView);
