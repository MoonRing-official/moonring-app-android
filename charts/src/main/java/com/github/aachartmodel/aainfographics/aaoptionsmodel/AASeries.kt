...
class AASeries {
    ...
    var pointPadding: Number? = null
    var groupPadding: Number? = null
    var pointWidth: Number? = null
    var maxPointWidth: Number? = null
    var allowPointSelect: Boolean? = null

    fun pointPadding(prop: Number?): AASeries {
        pointPadding = prop
        return this
    }
    fun maxPointWidth(prop: Number?): AASeries {
        maxPointWidth = prop
        return this
    }
    ...
    fun groupPadding(prop: Number?): AASeries {
        groupPadding = prop
        return this
    }

    fun pointWidth(prop: Number?): AASeries {
        pointWidth = prop
        return this
    }
