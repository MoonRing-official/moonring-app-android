package com.moonring.jetpackmvvm.ext.download

import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.withContext
import com.moonring.jetpackmvvm.base.appContextJvvm
...
object FileTool {
    ...
    fun getBasePath(): String {
        var p: String? = appContextJvvm.getExternalFilesDir(null)?.path
        val f: File? = appContextJvvm.getExternalFilesDir(null)
        if (null != f) {
            p = f.absolutePath
        }
        return p ?: ""
